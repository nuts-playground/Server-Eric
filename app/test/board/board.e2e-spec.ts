...
describe('[e2e] 보드 e2e 테스트 - board.e2e-spec.ts', () => {
    ...
    describe('[POST] /board/content', () => {
        it('정상 케이스', async() => {
            ...
            const response = await supertest(app.getHttpServer()).post('/board/content').send(reqData);
            expect(response.body.status).toStrictEqual('success');
            expect(response.body.message).toStrictEqual('');
        });
    ...
    describe('[PATCH] /board/content', () => {
        it('정상 케이스', async() => {
            ...
            const response = await supertest(app.getHttpServer()).patch('/board/content').send(reqData);
            expect(response.body.status).toStrictEqual('success');
            expect(response.body.message).toStrictEqual('');
        });
    ...
    describe('[POST] /board/commentList', () => {
        it('정상 케이스', async() => {
            ...
            const response = await supertest(app.getHttpServer()).post('/board/commentList').send(reqData);
            expect(response.body.status).toStrictEqual('success');
            expect(response.body.message).toStrictEqual('');
    ...
    describe('[POST] /board/comment', () => {
        it('정상 케이스', async() => {
            ...
            const response = await supertest(app.getHttpServer()).post('/board/comment').send(reqData);
            expect(response.body.status).toStrictEqual('success');
            expect(response.body.message).toStrictEqual('');
        });
    ...
    describe('[PATCH] /board/comment', () => {
        it('정상 케이스', async() => {
            ...
            const response = await supertest(app.getHttpServer()).patch('/board/comment').send(reqData);
            expect(response.body.status).toStrictEqual('success');
            expect(response.body.message).toStrictEqual('');
        });
    ...
    describe('[DELETE] /board/comment', () => {
        it('정상 케이스', async() => {
            ...
            const response = await supertest(app.getHttpServer()).delete('/board/comment').send(reqData);
            expect(response.body.status).toStrictEqual('success');
            expect(response.body.message).toStrictEqual('');
        });
